...
verbose = True
meshSize = 0.075 #standard: 0.005; 0.0011: memory limit (96GB) for NGsolve; < 0.0015 makes problems with scipy eigensolver
meshOrder = 2
...
if True:
    ...
    print("Test 1")
    [bfM, bfK, pre, fes] = femCrank.ImportMeshFromNGsolve(meshCrank, density, youngsModulus, poissonsRatio, verbose = True, meshOrder = meshOrder)
    ...
    if not eigenModesNGsolve:
        ...
        femCrank.ComputeEigenmodesNGsolve(bfM, bfK, pre, nModes=nModes,
    ...
    print("Test 2")
    [bfM, bfK, pre, fes] = femConrod.ImportMeshFromNGsolve(meshConrod, density, youngsModulus, poissonsRatio, verbose = False, meshOrder = meshOrder)
                          # computeEigenmodes=eigenModesNGsolve, excludeRigidBodyModes = 6,
                          # numberOfModes = nModes, maxEigensolveIterations=20)
    ...
    if not eigenModesNGsolve:
        ...
        femConrod.ComputeEigenmodesNGsolve(bfM, bfK, pre, nModes=nModes, excludeRigidBodyModes=excludeRigidBodyModes)
    ...
    print("Test 3")
    [bfM, bfK, pre, fes] = femPiston.ImportMeshFromNGsolve(meshPiston, density, youngsModulus, poissonsRatio, verbose = False, meshOrder = meshOrder)
    ...
    if not eigenModesNGsolve:
        ...
        femPiston.ComputeEigenmodesNGsolve(bfM, bfK, pre, nModes=nModes, excludeRigidBodyModes=excludeRigidBodyModes)
